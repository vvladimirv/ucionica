// Sve provjere redom: struktura (bez preglednika) → runneri → izvršavanje lekcija → UI → telefon.
...
import { provjeriRunnere } from './provjeri-runnere.mjs';
...
try {
  ...
  greske = rn.greske.length + iz.greske.length + ui.greske.length + stranica.length;
