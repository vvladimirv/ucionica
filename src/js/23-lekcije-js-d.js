...
console.log(\`Amra duguje \${dug} KM\`);`,
    ...
    { tip: 'tekst', naslov: 'Završio si JavaScript osnove 🎉', html: `
      ...
      <ul><li><b>Tema 2 (Frontend arhitektura)</b> je sada potpuno čitljiva: state, render, event delegation, service worker.</li><li><b>Tema 0 (put jednog klika)</b>: prođi je ponovo i prati koji korak je JavaScript, a koji Python.</li><li><b>Dio 3 · SQL i baze</b>: podaci iza svih ovih ekrana — pitanja pravoj bazi, od SELECT-a do transakcija.</li><li>Otvori <code>app-next-events.js</code>, nađi <code>closest(</code> i pitaj tutora da ti jedan takav slušač objasni liniju po liniju.</li></ul>
      <div class="row"><button class="btn primary" data-go="lek:sql1:0">Dio 3: SQL →</button><button class="btn" data-go="tema:m2">Tema 2: frontend arhitektura</button><button class="btn" data-go="tema:m0">Tema 0: put jednog klika</button></div>` },
